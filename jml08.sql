...
--
-- Servidor: 10.200.8.199
-- Tiempo de generación: 30-11-2020 a las 11:46:27
...
--
-- Estructura de tabla para la tabla `oxzku_action_logs`
--

CREATE TABLE IF NOT EXISTS `oxzku_action_logs` (
...
--
-- Volcado de datos para la tabla `oxzku_action_logs`
--

INSERT INTO `oxzku_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"564","username":"mcascal17","accountlink":"index.php?option=com_users&task=user.edit&id=564","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR"}', '2020-11-30 10:43:32', 'com_users', 564, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_action_logs_extensions`
--

CREATE TABLE IF NOT EXISTS `oxzku_action_logs_extensions` (
  `id` int(10) unsigned NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `oxzku_action_logs_extensions`
--

INSERT INTO `oxzku_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `oxzku_action_logs_users`
--

CREATE TABLE IF NOT EXISTS `oxzku_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `oxzku_action_log_config`
--

CREATE TABLE IF NOT EXISTS `oxzku_action_log_config` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `oxzku_action_log_config`
--

INSERT INTO `oxzku_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_assets`
--

CREATE TABLE IF NOT EXISTS `oxzku_assets` (
...
--
-- Volcado de datos para la tabla `oxzku_assets`
--

INSERT INTO `oxzku_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_associations`
--

CREATE TABLE IF NOT EXISTS `oxzku_associations` (
...
--
-- Estructura de tabla para la tabla `oxzku_banners`
--

CREATE TABLE IF NOT EXISTS `oxzku_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_banner_clients`
--

CREATE TABLE IF NOT EXISTS `oxzku_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `oxzku_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `oxzku_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `oxzku_categories`
--

CREATE TABLE IF NOT EXISTS `oxzku_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `oxzku_categories`
--

INSERT INTO `oxzku_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 564, '2020-11-30 10:42:57', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 564, '2020-11-30 10:42:57', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 564, '2020-11-30 10:42:57', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 564, '2020-11-30 10:42:57', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 564, '2020-11-30 10:42:57', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 564, '2020-11-30 10:42:57', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_contact_details`
--

CREATE TABLE IF NOT EXISTS `oxzku_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_content`
--

CREATE TABLE IF NOT EXISTS `oxzku_content` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `oxzku_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `oxzku_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `oxzku_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `oxzku_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `oxzku_content_rating`
--

CREATE TABLE IF NOT EXISTS `oxzku_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `oxzku_content_types`
--

CREATE TABLE IF NOT EXISTS `oxzku_content_types` (
...
--
-- Volcado de datos para la tabla `oxzku_content_types`
--

INSERT INTO `oxzku_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `oxzku_core_log_searches` (
...
--
-- Estructura de tabla para la tabla `oxzku_extensions`
--

CREATE TABLE IF NOT EXISTS `oxzku_extensions` (
...
--
-- Volcado de datos para la tabla `oxzku_extensions`
--

INSERT INTO `oxzku_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"4eaf218b9ac1df07c8741d6dcc7125f9"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1606733007}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `oxzku_fields`
--

CREATE TABLE IF NOT EXISTS `oxzku_fields` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_fields_categories`
--

CREATE TABLE IF NOT EXISTS `oxzku_fields_categories` (
...
--
-- Estructura de tabla para la tabla `oxzku_fields_groups`
--

CREATE TABLE IF NOT EXISTS `oxzku_fields_groups` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `oxzku_fields_values`
--

CREATE TABLE IF NOT EXISTS `oxzku_fields_values` (
...
--
-- Estructura de tabla para la tabla `oxzku_finder_filters`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_filters` (
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links` (
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Estructura de tabla para la tabla `oxzku_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla `oxzku_finder_taxonomy`
--

INSERT INTO `oxzku_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_finder_terms`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `oxzku_finder_terms_common`
--

INSERT INTO `oxzku_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla `oxzku_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `oxzku_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_finder_types`
--

CREATE TABLE IF NOT EXISTS `oxzku_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_languages`
--

CREATE TABLE IF NOT EXISTS `oxzku_languages` (
...
--
-- Volcado de datos para la tabla `oxzku_languages`
--

INSERT INTO `oxzku_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_menu`
--

CREATE TABLE IF NOT EXISTS `oxzku_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `oxzku_menu`
--

INSERT INTO `oxzku_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_menu_types`
--

CREATE TABLE IF NOT EXISTS `oxzku_menu_types` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `oxzku_menu_types`
--

INSERT INTO `oxzku_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_messages`
--

CREATE TABLE IF NOT EXISTS `oxzku_messages` (
...
--
-- Estructura de tabla para la tabla `oxzku_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `oxzku_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `oxzku_modules`
--

CREATE TABLE IF NOT EXISTS `oxzku_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `oxzku_modules`
--

INSERT INTO `oxzku_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_modules_menu`
--

CREATE TABLE IF NOT EXISTS `oxzku_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `oxzku_modules_menu`
--

INSERT INTO `oxzku_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `oxzku_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `oxzku_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_overrider`
--

CREATE TABLE IF NOT EXISTS `oxzku_overrider` (
...
--
-- Estructura de tabla para la tabla `oxzku_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `oxzku_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `oxzku_postinstall_messages`
--

INSERT INTO `oxzku_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_privacy_consents`
--

CREATE TABLE IF NOT EXISTS `oxzku_privacy_consents` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `oxzku_privacy_requests`
--

CREATE TABLE IF NOT EXISTS `oxzku_privacy_requests` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_redirect_links`
--

CREATE TABLE IF NOT EXISTS `oxzku_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_schemas`
--

CREATE TABLE IF NOT EXISTS `oxzku_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `oxzku_schemas`
--

INSERT INTO `oxzku_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.22-2020-09-16');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_session`
--

CREATE TABLE IF NOT EXISTS `oxzku_session` (
...
--
-- Volcado de datos para la tabla `oxzku_session`
--

INSERT INTO `oxzku_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x3363373466346538356433623432363434383261663866306662313933323732, 1, 0, 1606733015, 'joomla|s:868:"";', 564, 'mcascal17'),
(0x6233366331623865343666353462623834653665393863626636323363323134, 0, 1, 1606733043, 'joomla|s:736:"";', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_tags`
--

CREATE TABLE IF NOT EXISTS `oxzku_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla `oxzku_tags`
--

INSERT INTO `oxzku_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 564, '2020-11-30 10:42:57', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_template_styles`
--

CREATE TABLE IF NOT EXISTS `oxzku_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `oxzku_template_styles`
--

INSERT INTO `oxzku_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_ucm_base`
--

CREATE TABLE IF NOT EXISTS `oxzku_ucm_base` (
...
--
-- Estructura de tabla para la tabla `oxzku_ucm_content`
--

CREATE TABLE IF NOT EXISTS `oxzku_ucm_content` (
...
--
-- Estructura de tabla para la tabla `oxzku_ucm_history`
--

CREATE TABLE IF NOT EXISTS `oxzku_ucm_history` (
...
--
-- Estructura de tabla para la tabla `oxzku_updates`
--

CREATE TABLE IF NOT EXISTS `oxzku_updates` (
...
--
-- Volcado de datos para la tabla `oxzku_updates`
--

INSERT INTO `oxzku_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Estructura de tabla para la tabla `oxzku_update_sites`
--

CREATE TABLE IF NOT EXISTS `oxzku_update_sites` (
...
--
-- Volcado de datos para la tabla `oxzku_update_sites`
--

INSERT INTO `oxzku_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1606733007, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1606732980, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1606733013, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `oxzku_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `oxzku_update_sites_extensions`
--

INSERT INTO `oxzku_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(2, 10002),
(3, 28);
...
--
-- Estructura de tabla para la tabla `oxzku_usergroups`
--

CREATE TABLE IF NOT EXISTS `oxzku_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `oxzku_usergroups`
--

INSERT INTO `oxzku_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `oxzku_users`
--

CREATE TABLE IF NOT EXISTS `oxzku_users` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `oxzku_users`
--

INSERT INTO `oxzku_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(564, 'Super User', 'mcascal17', 'castano.calero.macario.jose@iescamas.es', '$2y$10$m/tT99wIJHLYdvrikFFxs.KTI3CJ6K9RrrEYKzZmgBRIwU5BkGa9q', 0, 1, '2020-11-30 10:42:57', '2020-11-30 10:43:32', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_user_keys`
--

CREATE TABLE IF NOT EXISTS `oxzku_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `oxzku_user_notes`
--

CREATE TABLE IF NOT EXISTS `oxzku_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `oxzku_user_profiles`
--

CREATE TABLE IF NOT EXISTS `oxzku_user_profiles` (
...
--
-- Estructura de tabla para la tabla `oxzku_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `oxzku_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `oxzku_user_usergroup_map`
--

INSERT INTO `oxzku_user_usergroup_map` (`user_id`, `group_id`) VALUES
(564, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `oxzku_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `oxzku_utf8_conversion`
--

INSERT INTO `oxzku_utf8_conversion` (`converted`) VALUES
(5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oxzku_viewlevels`
--

CREATE TABLE IF NOT EXISTS `oxzku_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `oxzku_viewlevels`
--

INSERT INTO `oxzku_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indices de la tabla `oxzku_action_logs`
--
ALTER TABLE `oxzku_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_action_logs_extensions`
--
ALTER TABLE `oxzku_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `oxzku_action_logs_users`
--
ALTER TABLE `oxzku_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `oxzku_action_log_config`
--
ALTER TABLE `oxzku_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `oxzku_assets`
--
ALTER TABLE `oxzku_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_associations`
--
ALTER TABLE `oxzku_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `oxzku_banners`
--
ALTER TABLE `oxzku_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_banner_clients`
--
ALTER TABLE `oxzku_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `oxzku_banner_tracks`
--
ALTER TABLE `oxzku_banner_tracks`
...
--
-- Indices de la tabla `oxzku_categories`
--
ALTER TABLE `oxzku_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_contact_details`
--
ALTER TABLE `oxzku_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `oxzku_content`
--
ALTER TABLE `oxzku_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `oxzku_contentitem_tag_map`
--
ALTER TABLE `oxzku_contentitem_tag_map`
...
--
-- Indices de la tabla `oxzku_content_frontpage`
--
ALTER TABLE `oxzku_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `oxzku_content_rating`
--
ALTER TABLE `oxzku_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `oxzku_content_types`
--
ALTER TABLE `oxzku_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `oxzku_extensions`
--
ALTER TABLE `oxzku_extensions`
...
--
-- Indices de la tabla `oxzku_fields`
--
ALTER TABLE `oxzku_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `oxzku_fields_categories`
--
ALTER TABLE `oxzku_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `oxzku_fields_groups`
--
ALTER TABLE `oxzku_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `oxzku_fields_values`
--
ALTER TABLE `oxzku_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `oxzku_finder_filters`
--
ALTER TABLE `oxzku_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `oxzku_finder_links`
--
ALTER TABLE `oxzku_finder_links`
...
--
-- Indices de la tabla `oxzku_finder_links_terms0`
--
ALTER TABLE `oxzku_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms1`
--
ALTER TABLE `oxzku_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms2`
--
ALTER TABLE `oxzku_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms3`
--
ALTER TABLE `oxzku_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms4`
--
ALTER TABLE `oxzku_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms5`
--
ALTER TABLE `oxzku_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms6`
--
ALTER TABLE `oxzku_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms7`
--
ALTER TABLE `oxzku_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms8`
--
ALTER TABLE `oxzku_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_terms9`
--
ALTER TABLE `oxzku_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_termsa`
--
ALTER TABLE `oxzku_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_termsb`
--
ALTER TABLE `oxzku_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_termsc`
--
ALTER TABLE `oxzku_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_termsd`
--
ALTER TABLE `oxzku_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_termse`
--
ALTER TABLE `oxzku_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_links_termsf`
--
ALTER TABLE `oxzku_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `oxzku_finder_taxonomy`
--
ALTER TABLE `oxzku_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_finder_taxonomy_map`
--
ALTER TABLE `oxzku_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `oxzku_finder_terms`
--
ALTER TABLE `oxzku_finder_terms`
...
--
-- Indices de la tabla `oxzku_finder_terms_common`
--
ALTER TABLE `oxzku_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `oxzku_finder_tokens`
--
ALTER TABLE `oxzku_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `oxzku_finder_tokens_aggregate`
--
ALTER TABLE `oxzku_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `oxzku_finder_types`
--
ALTER TABLE `oxzku_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `oxzku_languages`
--
ALTER TABLE `oxzku_languages`
...
--
-- Indices de la tabla `oxzku_menu`
--
ALTER TABLE `oxzku_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_menu_types`
--
ALTER TABLE `oxzku_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `oxzku_messages`
--
ALTER TABLE `oxzku_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `oxzku_messages_cfg`
--
ALTER TABLE `oxzku_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `oxzku_modules`
--
ALTER TABLE `oxzku_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_modules_menu`
--
ALTER TABLE `oxzku_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `oxzku_newsfeeds`
--
ALTER TABLE `oxzku_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `oxzku_overrider`
--
ALTER TABLE `oxzku_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `oxzku_postinstall_messages`
--
ALTER TABLE `oxzku_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `oxzku_privacy_consents`
--
ALTER TABLE `oxzku_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `oxzku_privacy_requests`
--
ALTER TABLE `oxzku_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `oxzku_redirect_links`
--
ALTER TABLE `oxzku_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `oxzku_schemas`
--
ALTER TABLE `oxzku_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `oxzku_session`
--
ALTER TABLE `oxzku_session`
...
--
-- Indices de la tabla `oxzku_tags`
--
ALTER TABLE `oxzku_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_template_styles`
--
ALTER TABLE `oxzku_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_ucm_base`
--
ALTER TABLE `oxzku_ucm_base`
...
--
-- Indices de la tabla `oxzku_ucm_content`
--
ALTER TABLE `oxzku_ucm_content`
...
--
-- Indices de la tabla `oxzku_ucm_history`
--
ALTER TABLE `oxzku_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `oxzku_updates`
--
ALTER TABLE `oxzku_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `oxzku_update_sites`
--
ALTER TABLE `oxzku_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `oxzku_update_sites_extensions`
--
ALTER TABLE `oxzku_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `oxzku_usergroups`
--
ALTER TABLE `oxzku_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_users`
--
ALTER TABLE `oxzku_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `oxzku_user_keys`
--
ALTER TABLE `oxzku_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `oxzku_user_notes`
--
ALTER TABLE `oxzku_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `oxzku_user_profiles`
--
ALTER TABLE `oxzku_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `oxzku_user_usergroup_map`
--
ALTER TABLE `oxzku_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `oxzku_viewlevels`
--
ALTER TABLE `oxzku_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `oxzku_action_logs`
--
ALTER TABLE `oxzku_action_logs`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `oxzku_action_logs_extensions`
--
ALTER TABLE `oxzku_action_logs_extensions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `oxzku_action_log_config`
--
ALTER TABLE `oxzku_action_log_config`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de la tabla `oxzku_assets`
--
ALTER TABLE `oxzku_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=61;
--
-- AUTO_INCREMENT de la tabla `oxzku_banners`
--
ALTER TABLE `oxzku_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_banner_clients`
--
ALTER TABLE `oxzku_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_categories`
--
ALTER TABLE `oxzku_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `oxzku_contact_details`
--
ALTER TABLE `oxzku_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_content`
--
ALTER TABLE `oxzku_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_content_types`
--
ALTER TABLE `oxzku_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `oxzku_extensions`
--
ALTER TABLE `oxzku_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT de la tabla `oxzku_fields`
--
ALTER TABLE `oxzku_fields`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_fields_groups`
--
ALTER TABLE `oxzku_fields_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_finder_filters`
--
ALTER TABLE `oxzku_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_finder_links`
--
ALTER TABLE `oxzku_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_finder_taxonomy`
--
ALTER TABLE `oxzku_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `oxzku_finder_terms`
--
ALTER TABLE `oxzku_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_finder_types`
--
ALTER TABLE `oxzku_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_languages`
--
ALTER TABLE `oxzku_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `oxzku_menu`
--
ALTER TABLE `oxzku_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT de la tabla `oxzku_menu_types`
--
ALTER TABLE `oxzku_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `oxzku_messages`
--
ALTER TABLE `oxzku_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_modules`
--
ALTER TABLE `oxzku_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT de la tabla `oxzku_newsfeeds`
--
ALTER TABLE `oxzku_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_overrider`
--
ALTER TABLE `oxzku_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT de la tabla `oxzku_postinstall_messages`
--
ALTER TABLE `oxzku_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `oxzku_privacy_consents`
--
ALTER TABLE `oxzku_privacy_consents`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_privacy_requests`
--
ALTER TABLE `oxzku_privacy_requests`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_redirect_links`
--
ALTER TABLE `oxzku_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_tags`
--
ALTER TABLE `oxzku_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `oxzku_template_styles`
--
ALTER TABLE `oxzku_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `oxzku_ucm_content`
--
ALTER TABLE `oxzku_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_ucm_history`
--
ALTER TABLE `oxzku_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_updates`
--
ALTER TABLE `oxzku_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT de la tabla `oxzku_update_sites`
--
ALTER TABLE `oxzku_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `oxzku_usergroups`
--
ALTER TABLE `oxzku_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `oxzku_users`
--
ALTER TABLE `oxzku_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=565;
--
-- AUTO_INCREMENT de la tabla `oxzku_user_keys`
--
ALTER TABLE `oxzku_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_user_notes`
--
ALTER TABLE `oxzku_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `oxzku_viewlevels`
--
ALTER TABLE `oxzku_viewlevels`
